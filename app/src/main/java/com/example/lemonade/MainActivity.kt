...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        //  TODO: If the lemonSize has reached 0, it has been juiced and the state should become DRINK
    ...
    private fun setViewElements() {
        ...
        var textResourse = when (lemonadeState){
        ...
        lemonImage!!.contentDescription  = textResourse.toString()
